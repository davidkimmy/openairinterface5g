...
/*   Sidelink Frequency dedicated configuration in SL-Preconfig */
#define SL_CONFIG_STRING_SL_FDC_LIST                           "sl_FrequencyDedicatedConfig"
...
#define SL_CONFIG_STRING_RESPOOL_ADDITIONAL_MCS_TABLE         "sl_Additional_MCS_Table"
...
/* Please refer to 3GPP SPEC 38.331 (RRC Specification) for details about these parameters
   ...
   sl_AbsoluteFrequencySSB_r16 - ARFCN of the center RE of sidelink SSB of length 11 RBs
*/
#define SL_FD_CONFIG_PARAMS_DESC(sl_fdc) { \
{SL_CONFIG_STRING_SLOFFSETTOCARRIER,NULL,0,.i64ptr=&sl_fdc->sl_SCS_SpecificCarrierList_r16.list.array[0]->offsetToCarrier,.defint64val=0,TYPE_INT64,0}, \
{SL_CONFIG_STRING_FCC_SUBCARRIERSPACING,NULL,0,.i64ptr=&sl_fdc->sl_SCS_SpecificCarrierList_r16.list.array[0]->subcarrierSpacing,.defint64val=NR_SubcarrierSpacing_kHz30,TYPE_INT64,0},\
{SL_CONFIG_STRING_SLCARRIERBANDWIDTH,NULL,0,.i64ptr=&sl_fdc->sl_SCS_SpecificCarrierList_r16.list.array[0]->carrierBandwidth,.defint64val=106,TYPE_INT64,0}, \
{SL_CONFIG_STRING_SLABSOLUEFREQUENCYPOINTA,NULL,0,.i64ptr=sl_fdc->sl_AbsoluteFrequencyPointA_r16,.defint64val=792000,TYPE_INT64,0},\
{SL_CONFIG_STRING_SLABSOLUTEFREQUENCYSSB,NULL,0,.i64ptr=sl_fdc->sl_AbsoluteFrequencySSB_r16,.defint64val=792372,TYPE_INT64,0}}
...
{SL_CONFIG_STRING_RESPOOL_ADDITIONAL_MCS_TABLE,NULL,0,.i64ptr=sl_res_pool->sl_Additional_MCS_Table_r16,.defint64val=2,TYPE_INT64,0}, \
