...
extern "C" {
#endif
// Upstream includes "common/platform_types.h" for c16_t/cf_t; on this branch those
// types live in PHY/TOOLS/tools_defs.h (platform_types.h moved paths over time).
